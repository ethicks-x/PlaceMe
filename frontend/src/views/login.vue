...
<template>
  <main class="d-grid h-100 p-4 overflow-auto" style="place-items: center">
    <div class="form-container">
      ...
      <div class="tab-content" id="myTabContent">
        ...
        >
          ...
          <form @submit.prevent="handleSignup" autocomplete="off">
            ...
            <div
              v-if="isPasswordFocused || signupForm.password.length > 0"
              class="password-info-box mt-2 p-3"
            >
              <p class="mb-2 text-white fw-bold" style="font-size: 0.9rem">
      ...
      <p>
        <router-link to="/company/register" class="switch-link"> Represent a company? </router-link>
      </p>
    </div>
  </main>
</template>
